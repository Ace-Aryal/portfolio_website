    ...
    <ul className="flex flex-col gap-3">
      {posts.map((post) => (
        <Link href={`/posts/${post.slug}`} key={post.slug}>
          <div
            key={post.slug}
            className="reveal my-2 grid w-full grid-cols-6 rounded-lg p-2 px-3 hover:bg-gray-100 focus:bg-gray-100 active:bg-gray-100 hover:dark:bg-gray-800 focus:dark:bg-gray-800 active:dark:bg-gray-800"
          >
